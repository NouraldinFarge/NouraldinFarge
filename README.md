...
| --- | --- | --- |
| [DrawScope](https://github.com/NouraldinFarge/drawscope) **v0.6.5** | Reproducible 41,598-row data lineage and leakage-resistant walk-forward research. React · Rust/Tauri · Python · SQLite. | [Source](https://github.com/NouraldinFarge/drawscope) · [Windows release](https://github.com/NouraldinFarge/drawscope/releases/tag/v0.6.5) · [Methodology](https://github.com/NouraldinFarge/drawscope/blob/main/docs/METHODOLOGY.md) |
| [GameVault](https://github.com/NouraldinFarge/gamevault) **v0.3.5** | Portable library management and review-gated ZIP intake that blocks traversal, unsafe paths, and link/reparse entries. React · Rust/Tauri · SQLite. | [Source](https://github.com/NouraldinFarge/gamevault) · [Windows release](https://github.com/NouraldinFarge/gamevault/releases/tag/v0.3.5) · [Safety model](https://github.com/NouraldinFarge/gamevault#safety-model) |
| [Day-Trading Teacher](https://github.com/NouraldinFarge/day-trading-teacher) **v0.32.6** | Deterministic risk practice, lessons, historical replay, journaling, and spaced review—without live signals or order execution. React · Rust/Tauri · local JSON · Zod. | [Source](https://github.com/NouraldinFarge/day-trading-teacher) · [Windows release](https://github.com/NouraldinFarge/day-trading-teacher/releases/tag/v0.32.6) · [Project tour](https://github.com/NouraldinFarge/day-trading-teacher#five-minute-project-tour) |
| [Research Studio](https://github.com/NouraldinFarge/research-studio-case-study) **alpha.21** | Guarded Chinese/English catalog enrichment with read-only sources, bounded batches, untrusted-output validation, human approval, and recoverable exports. Electron · React · TypeScript · Express · SQLite. | [Source-free case study](https://github.com/NouraldinFarge/research-studio-case-study) · [Verification evidence](https://github.com/NouraldinFarge/research-studio-case-study/blob/main/docs/verification-evidence.md) · [Threat model](https://github.com/NouraldinFarge/research-studio-case-study/blob/main/docs/threat-model.md) |
